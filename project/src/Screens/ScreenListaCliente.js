                            ...
                            lstClientes.map((it, idx)=>(
                                <tr key={idx}>
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <Button color='btn btn-outline-danger' onClick={()=>eliminarCliente(it.Id)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
